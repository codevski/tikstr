...
const Upload = () => {
  ...
  return (
    <div className="w-full mt-[80px] mb-[40px] bg-white shadow-lg rounded-md py-6 md:px-10 px-4">
      <div>
        <h1 className="text-[23px] font-semibold dark:text-gray-950">
          Upload video
        </h1>
      ...
      <div className="mt-8 md:flex gap-6">
        {!fileDisplay ? (
          ...
          <div className="md:mx-0 mx-auto mt-4 md:mb-12 mb-16 flex items-center justify-center w-full max-w-[260px] h-[540px] p-3 rounded-2xl cursor-pointer relative">
            ...
            <div className="absolute -bottom-12 flex items-center justify-between z-50 rounded-xl border w-full p-2 border-gray-300 text-gray-900">
        ...
        <div className="mt-4 mb-6">
          <div className="flex bg-[#F8F8F8] py-4 px-6">
            <div className="text-gray-900">
              <TfiSlice className="mr-4" size="20" />
            </div>
            <div>
              <div className="text-semibold text-[15px] mb-1.5 text-gray-900">
          ...
          <div className="mt-5">
            <div className="flex items-center justify-between">
              <div className="mb-1 text-[15px] text-gray-900">Caption</div>
            ...
            <input
              maxLength={150}
              type="text"
              className="w-full border p-2.5 rounded-md focus:outline-none bg-white text-gray-900"
              // value={caption}
          ...
          <div className="flex gap-3">
            <button
              ...
              onClick={() => discard()}
              className="px-10 py-2.5 mt-8 border text-[16px] hover:bg-gray-100 rounded-sm text-gray-900"
            >
              Discard
            </button>
            <button
