...
const EditProfile = ({ setEdit }: Props) => {
  ...
  return (
    ...
    >
      <div className="relative bg-white w-full max-w-[700px] sm:h-[580px] h-[655px] mx-3 p-4 rounded-lg mb-10 text-gray-900 h-[655px]">
        ...
        <div
          className={`h-[calc(500px-200px)] ${!true ? "mt-16" : "mt-[58px]"}`}
        >
          {!uploadedImage ? (
            <div>
              <div
              ...
              >
                ...
                <div className="flex items-center justify-center sm:-mt-6">
                  <div className="sm:w-[60%] w-full max-w-md">
                    ...
                    <p
                      className={`relative text-[11px] text-gray-500 ${false ? "mt-1" : "mt-4"}`}
                    >
